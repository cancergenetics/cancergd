...
#    url(r'^api/', include('gendep.urls_api')),
    ...
    # Added 'namespace="rootgendep"' to fix the warning when runserver.bat. So the cancergd namespaces are: ['admin', 'gendep', 'rootgendep'].
    #    WARNINGS: ?: (urls.W005) URL namespace 'gendep' isn't unique. You may not be able to reverse all URLs in this namespace
    # The warning is generated by script: C:\Users\HP\AppData\Local\Programs\Python\Python35\Lib\site-packages\django\core\checks\urls.py      
    url(r'^', include('gendep.urls', namespace = "rootgendep")),
    #  Also see: https://docs.djangoproject.com/en/1.11/topics/http/urls/
    
    # url(r'^', include('gendep.urls')),
]
